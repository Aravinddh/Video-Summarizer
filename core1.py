...
def summarize_text(text, max_length=100, min_length=30):
    ...
    # Adjust max_length and min_length dynamically based on input length
    ...
    try:
        summary = summarizer(text, max_length=max_length, min_length=min_length, max_new_tokens=100, do_sample=False)
...
if __name__ == "__main__":
    example_text = "This is a very short example."
